...
from src.peft.import_utils import is_bnb_4bit_available, is_bnb_available, is_xpu_available
from src.peft.tuners.lora.config import LoraRuntimeConfig
from src.peft.utils import infer_device
...
if is_bnb_available():
    ...
    from src.peft.tuners.ia3 import Linear8bitLt as IA3Linear8bitLt
    from src.peft.tuners.lora import Linear8bitLt as LoraLinear8bitLt
    from src.peft.tuners.vera import Linear8bitLt as VeraLinear8bitLt

    if is_bnb_4bit_available():
        from src.peft.tuners.ia3 import Linear4bit as IA3Linear4bit
        from src.peft.tuners.lora import Linear4bit as LoraLinear4bit
        from src.peft.tuners.vera import Linear4bit as VeraLinear4bit
