...
from src.peft.mapping import PEFT_TYPE_TO_PREFIX_MAPPING
from src.peft.tuners.lora.config import CordaConfig
from src.peft.tuners.lora.corda import preprocess_corda
from src.peft.tuners.lora.layer import LoraLayer
from src.peft.utils import infer_device
from src.peft.utils.hotswap import hotswap_adapter
...
def test_import_peft_type_to_model_mapping_deprecation_warning(recwarn):
    ...
    from src.peft.peft_model import PeftModel  # noqa
    ...
    from src.peft.peft_model import PEFT_TYPE_TO_MODEL_MAPPING  # noqa
