...
from src.peft.tuners.tuners_utils import BaseTuner, BaseTunerLayer
from src.peft.utils.constants import DUMMY_MODEL_CONFIG
from src.peft.utils.integrations import init_empty_weights
...
class PeftModelForSequenceClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from src.peft import PeftModelForSequenceClassification, get_peft_config
...
class PeftModelForCausalLM(PeftModel):
    ...
    Example:
        ...
        >>> from src.peft import PeftModelForCausalLM, get_peft_config
...
class PeftModelForSeq2SeqLM(PeftModel):
    ...
    Example:
        ...
        >>> from src.peft import PeftModelForSeq2SeqLM, get_peft_config
...
class PeftModelForTokenClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from transformers import AutoModelForSequenceClassification
        >>> from src.peft import PeftModelForTokenClassification, get_peft_config
...
class PeftModelForQuestionAnswering(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from src.peft import PeftModelForQuestionAnswering, get_peft_config
...
class PeftModelForFeatureExtraction(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from src.peft import PeftModelForFeatureExtraction, get_peft_config
...
def __getattr__(name):
    if name == "PEFT_TYPE_TO_MODEL_MAPPING":
        ...
        msg = (
            "PEFT_TYPE_TO_MODEL_MAPPING is deprecated, please use `from src.peft import PEFT_TYPE_TO_TUNER_MAPPING` instead. "
