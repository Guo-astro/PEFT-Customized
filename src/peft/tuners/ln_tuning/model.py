...
from src.peft.config import PeftConfig
from src.peft.tuners.tuners_utils import BaseTuner, _get_submodules, check_target_module_exists
from src.peft.utils import TRANSFORMERS_MODELS_TO_LNTUNING_TARGET_MODULES_MAPPING, ModulesToSaveWrapper
...
class LNTuningModel(BaseTuner):
    ...
    Example:
        ...
        >>> from src.peft import get_peft_model, TaskType, LNTuningConfig
