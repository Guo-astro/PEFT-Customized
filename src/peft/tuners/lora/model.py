...
from src.peft.import_utils import is_bnb_4bit_available, is_bnb_available
from src.peft.tuners.tuners_utils import (
    BaseTuner,
    BaseTunerLayer,
...
from src.peft.utils.merge_utils import dare_linear, dare_ties, magnitude_prune, task_arithmetic, ties
from src.peft.utils.other import get_pattern_key
...
class LoraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from src.peft import LoraModel, LoraConfig
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        from src.peft.tuners.adalora import AdaLoraLayer
