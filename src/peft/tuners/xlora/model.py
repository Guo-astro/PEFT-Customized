...
from src.peft.tuners.lora.layer import LoraLayer
from src.peft.tuners.lora.model import LoraModel
from src.peft.tuners.tuners_utils import BaseTuner
from src.peft.utils.constants import DUMMY_TARGET_MODULES
from src.peft.utils.save_and_load import set_peft_model_state_dict
...
def _load_adapter_into_lora_model(
    ...
    **kwargs,
    ...
    """
    from src.peft.peft_model import PeftModel
    from src.peft.tuners.lora.config import LoraConfig
    from src.peft.utils.other import infer_device
    from src.peft.utils.save_and_load import load_peft_weights
...
class XLoraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from src.peft import LoraConfig, PeftModel, get_peft_model, prepare_model_for_kbit_training
