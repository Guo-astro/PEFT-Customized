...
from src.peft.utils import INCLUDE_LINEAR_LAYERS_SHORTHAND
from src.peft.utils.constants import (
    DUMMY_MODEL_CONFIG,
...
from src.peft.utils.peft_types import PeftType, TaskType
...
def _find_minimal_target_modules(
    ...
    Example:
        ```py
        >>> from src.peft.tuners.tuners_utils import _find_minimal_target_modules
