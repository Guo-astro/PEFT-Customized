...
class PeftMixedModel(PushToHubMixin, torch.nn.Module):
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        """
        # note: adapted from src.peftModel.from_pretrained
        ...
        # note: this is different from src.peftModel.from_pretrained
        ...
        # note: this is different from src.peftModel.from_pretrained, we always return a PeftMixedModel
