...
def update_forward_signature(model: PeftModel) -> None:
    ...
    >>> from src.peft import get_peft_model, LoraConfig, update_forward_signature
...
def update_generate_signature(model: PeftModel) -> None:
    ...
    >>> from src.peft import get_peft_model, LoraConfig, TaskType, update_generate_signature
...
def update_signature(model: PeftModel, method: str = "all") -> None:
    ...
    ```python
    >>> from transformers import AutoModelForSeq2SeqLM, AutoTokenizer
    >>> from src.peft import get_peft_model, LoraConfig, TaskType, update_signature
